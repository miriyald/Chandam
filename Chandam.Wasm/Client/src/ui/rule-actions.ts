...
function renderFavoriteButton(isFavorited: boolean, ruleSetId: string, ruleId: string): string {
  const heartSvg = `<span class="material-symbols-outlined" style="font-size:24px" aria-hidden="true">favorite</span>`;
...
function renderCreateRuleButton(): string {
  const plusSvg = `<span class="material-symbols-outlined" style="font-size:20px" aria-hidden="true">add</span>`;
