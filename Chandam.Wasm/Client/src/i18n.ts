...
const translations: Record<Language, Translations> = {
  ...
  te: {
    ...
    filter_try_removing: 'మరిన్ని ఫలితాలను చూడటానికి కొన్ని వడపోతలను తీసివేసి ప్రయత్నించండి.',
